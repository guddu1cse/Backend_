    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests(request->{
                request.requestMatchers("/login" , "/register").permitAll(); //this api access any user even which have not registered
                request.requestMatchers("/products").hasAnyRole("ADMIN" , "USER"); //products accessible By Both Role
